...
import { EntryWithAnalysis, Insight } from "@shared/schema";
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          <section id="insights" className="mt-2 md:mt-10">
            <h2 className="text-2xl font-bold text-neutral-500 dark:text-gray-200 mb-6">
              Your Insights
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="relative h-48 md:h-64 rounded-xl overflow-hidden shadow-md">
                <svg
                  viewBox="0 0 800 600"
                  className="w-full h-full bg-primary bg-opacity-10"
                >
              ...
              <div className="relative h-48 md:h-64 rounded-xl overflow-hidden shadow-md">
                <svg
                  viewBox="0 0 800 600"
                  className="w-full h-full bg-secondary bg-opacity-10"
                >
                  <rect width="800" height="600" fill="#f8fafc" />
                  <circle
                    cx="200"
              ...
              <div className="relative h-48 md:h-64 rounded-xl overflow-hidden shadow-md">
                <svg
                  viewBox="0 0 800 600"
                  className="w-full h-full bg-accent bg-opacity-10"
                >
                  <rect width="800" height="600" fill="#f8fafc" />
                  <rect
                    x="100"
