  ...
  const filteredEntries = entries
    .filter(entry => {
      ...
      const matchesEmotion = filterEmotion === "all" ||
        entry.emotions?.some(e => e.emotion.toLowerCase() === filterEmotion.toLowerCase());
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <h1 className="text-2xl font-bold text-neutral-500 dark:text-gray-200 mb-4 sm:mb-0">All Journal Entries</h1>
          ...
          {isLoading ? (
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start">
                        <div>
                          <h2 className="text-xl font-semibold text-neutral-600 dark:text-gray-200">{entry.title}</h2>
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        {formattedEmotions.map((emotion, i) => (
                          <Badge key={i} className={`bg-${emotion.color} text-white`}>
                            {emotion.emotion}
                          </Badge>
                        ))}
            ...
            <div className="text-center py-12 text-neutral-400 dark:text-gray-500">
              ...
              <p>Try adjusting your search or filters, or create a new entry.</p>
              <Button 
                variant="outline" 
                className="mt-4"
